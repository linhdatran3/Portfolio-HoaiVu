...
const List = () => {
  ...
  return (
    <div>
      <Grid container spacing={1} style={{ padding: "1rem 6rem" }}>
          ...
          >
            <Card sx={{ maxWidth: 350 }}>
              <CardMedia
                component="img"
                height="194"
                image="../Cay-co-don-ben-ho-thuy-dien-song-hinh.jpg"
                alt="Paella dish"
              />
              <CardContent>
          ...
          >
            <Card sx={{ maxWidth: 350 }}>
              <CardMedia
                component="img"
                height="194"
                image="../binh-min-bai-mon-mui-dien.jpg"
                alt="Paella dish"
              />
              <CardContent>
                <Typography variant="body2" color="text.secondary">
